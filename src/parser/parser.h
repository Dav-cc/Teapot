...
http_parser_t* parse_request(buffer_t* read_buffer, size_t read_len, http_request_t* req);
void parser_destroy(http_request_t* req);
http_parser_state_t parse_request_line(buffer_t* buff, http_request_t* req);
